...
import 'package:catch_the_cat/src/features/game/presentation/screens/game_screen/widgets/hex_cell_widget.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final availableW =
            constraints.maxWidth - outerPadding * 2 - boardPadding * 2;
        ...
        return Padding(
          padding:
              const EdgeInsets.symmetric(horizontal: outerPadding, vertical: 8),
          child: Container(
